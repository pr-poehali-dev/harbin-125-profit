          ...
          <div className="grid md:grid-cols-3 gap-10 mb-16">
            {[
              ...
              },
              {
                ...
                tagline: 'Максимум',
                rating: 5,
                description: 'Самое крепкое пиво в линейке с насыщенным вкусом и долгим послевкусием. Для тех, кто ценит силу характера.',
                notes: ['Интенсивный солод', 'Карамель', 'Хмель', 'Полнотелость'],
                bestFor: { icon: '💪', text: 'Вечерние посиделки, эксперты' },
